		...
		<view class="page-body uni-content-info">
			...
			<view class='cropper-config'>
				<view class="button-box" >
					<button type="warn" @click="getImage" > 重选 </button>
					<button type="warn" @click="getImageInfo"> 预览 </button>
					<button type="warn" @click="finish"> 完成 </button>
				</view>
				
			</view>
			<canvas canvas-id="myCanvas" :style="'position:absolute;border: 2px solid red; width:'+imageW+'px;height:'+imageH+'px;top:-9999px;left:-9999px;'"></canvas>
		</view>
			...
			loadImage: function () {
				...
				uni.getImageInfo({
					...
					success: function success(res) {
						...
						IMG_RATIO = imgW / imgH;
						if(IMG_RATIO<1 && IMG_SCR_H_R<IMG_SCR_W_R ){ //图片更高一些
							IMG_REAL_H = SCREEN_HEIGHT-40;
							IMG_REAL_H = SCREEN_HEIGHT * IMG_RATIO>(SCREEN_WIDTH-40)? SCREEN_WIDTH-40 : SCREEN_HEIGHT * IMG_RATIO;
						}
						else{
							IMG_REAL_W = SCREEN_WIDTH-40;
